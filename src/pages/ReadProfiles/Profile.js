...
import { Card, CardBody, Nav, Dropdown, DropdownItem, DropdownToggle, DropdownMenu, Button } from "reactstrap";
...
// Actions
import { activeTale, setActiveTab } from '../../redux/actions';
...
export default connect(null, { activeTale, setActiveTab })(Profile);